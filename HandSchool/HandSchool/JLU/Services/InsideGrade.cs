...
[assembly: RegisterService(typeof(InsideGradeEntrance))]
    ...
    internal sealed class InsideGradeEntrance : IGradeEntrance
    {
        ...
        public InsideGradeEntrance()
        {
            Task.Run(async () =>
            {
                ...
                var LastReportGPA = Core.ReadConfig(configGpa);
                if (LastReportGPA != "") GradePointViewModel.Instance.Add(ParseGPA(LastReportGPA));

                var LastReport = Core.ReadConfig(configGrade);
