...
{
    [Entrance("快捷选课", "对您备选的选课列表进行操作。", EntranceType.InfoEntrance)]
        ...
        public SelectCourse()
        {
            HtmlDocument = new Bootstrap
            {
                Children =
                {
                    ...
                    "<table class=\"table\">" +
                    "<thead><tr><th>状态</th><th>课程</th><th>类型</th></tr></thead><tbody id=\"courList\">" +
                    "</tbody></table>" +

                    "<table class=\"table\">" +
                    "<thead><tr><th>教师</th><th>操作</th><th>时间</th></tr></thead><tbody id=\"schList\">" +
