...
namespace HandSchool
{
    public sealed partial class Core
    {
        ...
        {
            string fn = Path.Combine(ConfigDirectory, config);
        ...
        {
            File.WriteAllText(Path.Combine(ConfigDirectory, config), value);
        }
        ...
        {
            var fileName = Path.Combine(ConfigDirectory, config);
