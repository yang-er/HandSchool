...
namespace HandSchool.ViewModels
{
    public class NavigationViewModel : BaseViewModel
    {
        ...
        private NavigationViewModel()
        {
            ...
            if (App.Current.Feed != null) PrimaryItems.Add(new MasterPageItem("学校通知", "FeedPage", "\xED0D", "tab_feed.png"));
            if (App.Current.Message != null) PrimaryItems.Add(new MasterPageItem("站内消息", "MessagePage", "\xE715", "tab_feed.png"));
            if (App.Current.GradePoint != null) PrimaryItems.Add(new MasterPageItem("学分成绩", "GradePointPage", "\xE82D", "tab_feed.png"));
            if (App.Current.InfoEntrances.Count > 0) PrimaryItems.Add(new MasterPageItem("信息查询", "InfoQueryPage", "\xE946", "tab_feed.png"));
